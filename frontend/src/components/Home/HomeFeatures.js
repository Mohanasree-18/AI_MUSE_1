                  ...
                  <div className="slider-container">
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Muse AI revolutionizes the way you create content. Our
                          intelligent algorithms generate high-quality, engaging
                          material, saving you time and enhancing your creative
                          output.
                        </p>
                      </div>
                    </div>
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          stories, Muse AI tailors content to your specific
                    ...
                    <div className="slide flex items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Integrating seamlessly with various platforms, Muse AI
                          becomes a natural extension of your workflow, making
                          content generation more efficient than ever before.
                        </p>
                      </div>
                    </div>
                  </div>
